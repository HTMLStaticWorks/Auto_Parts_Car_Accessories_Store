$dir = "d:\August Websites\Auto Parts & Car Accessories Store"
$files = Get-ChildItem -Path $dir -Filter "*.html"

$newContent = '<div class="mt-4">
...
$oldContentRegex = '<div class="mt-4">\s*<a href="#" class="social-icon"><i data-lucide="facebook" size="18"></i></a>\s*<a href="#" class="social-icon"><i data-lucide="twitter" size="18"></i></a>\s*<a href="#" class="social-icon"><i data-lucide="instagram" size="18"></i></a>\s*<a href="#" class="social-icon"><i data-lucide="youtube" size="18"></i></a>\s*</div>'

foreach ($file in $files) {
    $content = Get-Content -Path $file.FullName -Raw
    
    if ($content -match $oldContentRegex) {
